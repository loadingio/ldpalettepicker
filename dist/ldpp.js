...
ldPalettePicker = function(node, opt){
  var root, el, content, mypal, x$, ret, log, ldcp, ldrs, irsOpt, ref$, getIdx, dragger, palFromNode, usePal, search, editInit, editUpdate, evts, this$ = this;
  opt == null && (opt = {});
  opt = import$({
    palettes: [],
    itemPerLine: 2
  ...
  if (opt.mypal != null) {
    ...
    x$ = mypal.page;
    x$.setHost(el.pn.mypal);
    x$.on('scroll.fetch', function(it){
